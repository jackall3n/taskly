...
let BarcodesController = class BarcodesController {
    generate(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const url = `${process.env.URL}/promo/${id}`;
            const data = yield QRCode.toDataURL(url);
            response.send(`
            <img src="${data}" alt="barcode"/>
        `);
        });
    }
};
__decorate([
    decorators_1.Get('/:id/generate/'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], BarcodesController.prototype, "generate", null);
BarcodesController = __decorate([
